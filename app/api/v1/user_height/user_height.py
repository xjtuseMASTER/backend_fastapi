...
from app.controllers.user_height_controller import user_height_controller
...
@router.get("/getheightlist", summary="获取历史身高记录")
async def get_user_heights(userId: str = Query(..., description="用户ID")):
