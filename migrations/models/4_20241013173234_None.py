...
CREATE TABLE IF NOT EXISTS `t_comment` (
    ...
    `likes_num` INT NOT NULL  COMMENT '点赞数量' DEFAULT 0,
    `post_id_id` VARCHAR(36) NOT NULL COMMENT '关联帖子ID',
    `user_id_id` VARCHAR(36) NOT NULL COMMENT '用户ID',
    CONSTRAINT `fk_t_commen_t_post_3e6d48b8` FOREIGN KEY (`post_id_id`) REFERENCES `t_post` (`post_id`) ON DELETE CASCADE,
    CONSTRAINT `fk_t_commen_t_user_df7854db` FOREIGN KEY (`user_id_id`) REFERENCES `t_user` (`user_id`) ON DELETE CASCADE
